...
import {
    ...
    getWorkShopFrameWorkConfigForDeployMini,
...
import {
    getMenusItems,
    getMenusItemsForDeployMini,
} from "../workshop-framework/router";
...
export const getDefaultAppConfigForDeployMini = (lang: Locale) => {
    return getWorkShopFrameWorkConfigForDeployMini(
        getMenusItemsForDeployMini(),
        lang,
        getNavItemForDeployMini(lang)
    );
};
