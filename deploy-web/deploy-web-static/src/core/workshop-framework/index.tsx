...
export const getWorkShopFrameWorkConfigForDeployMini = (
    menusItems: any,
    lang: Locale,
    navItems: any
) => {
...
export function workShopFrameWorkConfigFactory(
    ...
    let menuItems: Array<MenuType> = workShopFrameWorkConfig!.nav!.menu!.items!;
    ...
    return {
        ...
        nav: {
            ...
            menu: {
                ...appConfig.nav.menu,
                items: [
                    ...filteredRoleRegistryInfos,
                    ...(userInfo?.user?.roles?.some((role) => {
                        return [
                            SystemRoleType.Admin,
                            SystemRoleType.Supper,
                        ].includes(role?.id as SystemRoleType);
                    })
                        ? menuItems
                        : []),
                ],
