...
class Test_Operator:
    ...
    def test_1(self, host):
        ...
        SSH_CLIENT.exec_cmd(
            cmd_str="kubectl create secret generic rds-secret --from-literal=username=FAKE_USERNAME --from-literal=password=FAKE_PASSWORD",
            timeout=30
        )
        ...
        SSH_CLIENT.exec_cmd(
            cmd_str="firewall-cmd --add-port=3306/tcp",
            timeout=30
        )
        db = common.DBClient(host, 3306, "FAKE_USERNAME", "FAKE_PASSWORD")
        db.is_health()
    ...
    def test_5(self, host):
        ...
        resp = requests.put(
            ...
            headers={
                "Content-Type": "application/json",
                "admin-key":"RkFLRV9VU0VSTkFNRTpGQUtFX1BBU1NXT1JE",
            },
            data=json.dumps(
                {
                "charset":"utf8mb4"
