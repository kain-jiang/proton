...
func defaultManifest(info architectureInfo) *Manifest {
	return &Manifest{
		...
		Spec: ManifestSpec{
			...
			Images: []Artifact{
				ociArtifact("busybox:1.36.1", "docker.io/library/busybox:1.36.1"),
				...
				ociArtifact("ingress-nginx-controller:v1.15.0", "registry.k8s.io/ingress-nginx/controller:v1.15.0"),
				ociArtifact("ingress-nginx-kube-webhook-certgen:v1.6.8", "registry.k8s.io/ingress-nginx/kube-webhook-certgen:v1.6.8"),
				ociArtifact("public/kafka-exporter:v1.6.0", "docker.io/danielqsj/kafka-exporter:v1.6.0"),
				ociArtifact("kube-apiserver:v1.35.2", "registry.k8s.io/kube-apiserver:v1.35.2"),
				ociArtifact("kube-controller-manager:v1.35.2", "registry.k8s.io/kube-controller-manager:v1.35.2"),
				ociArtifact("kube-proxy:v1.35.2", "registry.k8s.io/kube-proxy:v1.35.2"),
				ociArtifact("kube-rbac-proxy:v0.11.0", "quay.io/brancz/kube-rbac-proxy:v0.11.0"),
				ociArtifact("kube-scheduler:v1.35.2", "registry.k8s.io/kube-scheduler:v1.35.2"),
				ociArtifact("pause:3.10.1", "registry.k8s.io/pause:3.10.1"),
				ociArtifact("prometheus-config-reloader:v0.66.0", "ghcr.io/prometheus-operator/prometheus-config-reloader:v0.66.0"),
				ociArtifact("prometheus:v2.37.8", "quay.io/prometheus/prometheus:v2.37.8"),
				...
				ociArtifact("public/oliver006/redis_exporter:v1.77.0", "quay.io/oliver006/redis_exporter:v1.77.0"),
			...
			RPMs: []Artifact{
				httpArtifact("containerd-2.2.0-2.el10_2.x86_64.rpm", "https://mirrors.huaweicloud.com/epel/10/Everything/"+info.packageArch+"/Packages/c/containerd-2.2.0-2.el10_2."+info.packageArch+".rpm", "", ""),
				httpArtifact("cri-tools-1.35.0-150500.1.1."+info.packageArch+".rpm", "https://mirrors.huaweicloud.com/kubernetes-new/core:/stable:/v1.35/rpm/"+info.packageArch+"/cri-tools-1.35.0-150500.1.1."+info.packageArch+".rpm", "", ""),
				...
				httpArtifact("kubeadm-1.35.2-150500.1.1."+info.packageArch+".rpm", "https://mirrors.huaweicloud.com/kubernetes-new/core:/stable:/v1.35/rpm/"+info.packageArch+"/kubeadm-1.35.2-150500.1.1."+info.packageArch+".rpm", "", ""),
				httpArtifact("kubectl-1.35.2-150500.1.1."+info.packageArch+".rpm", "https://mirrors.huaweicloud.com/kubernetes-new/core:/stable:/v1.35/rpm/"+info.packageArch+"/kubectl-1.35.2-150500.1.1."+info.packageArch+".rpm", "", ""),
				httpArtifact("kubelet-1.35.2-150500.1.1."+info.packageArch+".rpm", "https://mirrors.huaweicloud.com/kubernetes-new/core:/stable:/v1.35/rpm/"+info.packageArch+"/kubelet-1.35.2-150500.1.1."+info.packageArch+".rpm", "", ""),
				httpArtifact("kubernetes-cni-1.8.0-150500.1.1."+info.packageArch+".rpm", "https://mirrors.huaweicloud.com/kubernetes-new/core:/stable:/v1.35/rpm/"+info.packageArch+"/kubernetes-cni-1.8.0-150500.1.1."+info.packageArch+".rpm", "", ""),
				...
				httpArtifact("runc-1.4.0-1.el10_2.x86_64.rpm", "https://mirrors.huaweicloud.com/epel/10/Everything/"+info.packageArch+"/Packages/r/runc-1.4.0-1.el10_2."+info.packageArch+".rpm", "", ""),
			},
		},
	}
}
