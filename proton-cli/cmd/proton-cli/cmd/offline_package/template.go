	...
	return &Manifest{
		...
		Spec: ManifestSpec{
			...
			Images: []Artifact{
				...
				ociArtifact("coredns:v1.13.1", "swr.cn-east-3.myhuaweicloud.com/kweaver-ai/mirror/registry.k8s.io/coredns/coredns:v1.13.1"),
				ociArtifact("etcd:3.6.6-0", "swr.cn-east-3.myhuaweicloud.com/kweaver-ai/mirror/registry.k8s.io/etcd:3.6.6-0"),
				...
				ociArtifact("kube-apiserver:v1.35.2", "swr.cn-east-3.myhuaweicloud.com/kweaver-ai/mirror/registry.k8s.io/kube-apiserver:v1.35.2"),
				ociArtifact("kube-controller-manager:v1.35.2", "swr.cn-east-3.myhuaweicloud.com/kweaver-ai/mirror/registry.k8s.io/kube-controller-manager:v1.35.2"),
				ociArtifact("kube-proxy:v1.35.2", "swr.cn-east-3.myhuaweicloud.com/kweaver-ai/mirror/registry.k8s.io/kube-proxy:v1.35.2"),
				...
				ociArtifact("kube-scheduler:v1.35.2", "swr.cn-east-3.myhuaweicloud.com/kweaver-ai/mirror/registry.k8s.io/kube-scheduler:v1.35.2"),
			...
			RPMs: []Artifact{
				...
				httpArtifact("cri-tools-1.35.0-150500.1.1."+info.packageArch+".rpm", "https://mirrors.aliyun.com/kubernetes-new/core:/stable:/v1.35/rpm/"+info.packageArch+"/cri-tools-1.35.0-150500.1.1."+info.packageArch+".rpm", "", ""),
				...
				httpArtifact("kubeadm-1.35.2-150500.1.1."+info.packageArch+".rpm", "https://mirrors.aliyun.com/kubernetes-new/core:/stable:/v1.35/rpm/"+info.packageArch+"/kubeadm-1.35.2-150500.1.1."+info.packageArch+".rpm", "", ""),
				httpArtifact("kubectl-1.35.2-150500.1.1."+info.packageArch+".rpm", "https://mirrors.aliyun.com/kubernetes-new/core:/stable:/v1.35/rpm/"+info.packageArch+"/kubectl-1.35.2-150500.1.1."+info.packageArch+".rpm", "", ""),
				httpArtifact("kubelet-1.35.2-150500.1.1."+info.packageArch+".rpm", "https://mirrors.aliyun.com/kubernetes-new/core:/stable:/v1.35/rpm/"+info.packageArch+"/kubelet-1.35.2-150500.1.1."+info.packageArch+".rpm", "", ""),
				httpArtifact("kubernetes-cni-1.8.0-150500.1.1."+info.packageArch+".rpm", "https://mirrors.aliyun.com/kubernetes-new/core:/stable:/v1.35/rpm/"+info.packageArch+"/kubernetes-cni-1.8.0-150500.1.1."+info.packageArch+".rpm", "", ""),
