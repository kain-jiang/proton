	...
	return &Manifest{
		...
		Spec: ManifestSpec{
			...
			RPMs: []Artifact{
				...
				httpArtifact("cri-tools-1.35.0-150500.1.1."+info.packageArch+".rpm", "https://pkgs.k8s.io/core:/stable:/v1.35/rpm/"+info.packageArch+"/cri-tools-1.35.0-150500.1.1."+info.packageArch+".rpm", "", ""),
				...
				httpArtifact("kubernetes-cni-1.8.0-150500.1.1."+info.packageArch+".rpm", "https://pkgs.k8s.io/core:/stable:/v1.35/rpm/"+info.packageArch+"/kubernetes-cni-1.8.0-150500.1.1."+info.packageArch+".rpm", "", ""),
