...
{{- end }}
            ...
            - name: CALICO_IPV6POOL_CIDR
              value: "{{ .PodNetworkCIDRv6 }}"
            - name: CALICO_IPV6POOL_BLOCK_SIZE
              value: "116"
            - name: CALICO_IPV6POOL_NAT_OUTGOING
              value: "true"
            {{- if not .PodNetworkCIDRv4 }}
            - name: IP6
              valueFrom:
                fieldRef:
                  fieldPath: status.hostIP
          ...
          {{- end }}
            ...
            - name: FELIX_HEALTHENABLED
              value: "true"
              # compatibility with iptables 1.8.x default nf_tables
...
func (c *Calico) renderTemplate(t string) error {
